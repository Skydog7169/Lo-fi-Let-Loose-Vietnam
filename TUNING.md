...
- **AI-vs-AI is defender-favoured** after dig-in/economy retune (≈1 in 8 attacker wins): the scripted attacker masses infantry in the open in front of the An Cuong village and bleeds. Human attackers have the tools it does not use well (dig in to hold ground, barrage/strafe/HE vs dug-in screens, redeploy a garrison forward, recon to find the forward garrison and stomp it). Treat the AI attacker as a smoke test, not a balance oracle.
